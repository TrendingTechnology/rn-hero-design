...
let _WRAPPER_MARGIN_HORIZONTAL = 0.0
let _WRAPPER_NO_HOME_BAR_MARGIN_BOTTOM = 0.0
let _WRAPPER_NO_HOME_BAR_PADDING_BOTTOM = 0.0
let _WRAPPER_WITH_HOME_BAR_MARGIN_BOTTOM = 0.0
let _WRAPPER_WITH_HOME_BAR_PADDING_BOTTOM = bottomInset
...
let _DISABLED_BACKGROUND_COLOR = Legacy_Variables._DISABLED_BACKGROUND_COLOR
