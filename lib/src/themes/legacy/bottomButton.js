...
const WRAPPER_MARGIN_HORIZONTAL = 0;
const WRAPPER_NO_HOME_BAR_MARGIN_BOTTOM = 0;
const WRAPPER_NO_HOME_BAR_PADDING_BOTTOM = 0;
const WRAPPER_WITH_HOME_BAR_MARGIN_BOTTOM = 0;
const WRAPPER_WITH_HOME_BAR_PADDING_BOTTOM = bottomInset;
