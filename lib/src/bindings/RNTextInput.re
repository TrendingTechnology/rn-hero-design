...
module Event = ReactNative.Event;
module TextInput_DataDetectorTypes = ReactNative.TextInput_DataDetectorTypes;
module Color = ReactNative.Color;
module AccessibilityState = ReactNative.AccessibilityState;
module AccessibilityTrait = ReactNative.AccessibilityTrait;
