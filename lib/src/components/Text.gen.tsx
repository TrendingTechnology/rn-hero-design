/* TypeScript file generated from Text.res by genType. */
/* eslint-disable import/first */


import * as React from 'react';

const $$toRE574697216: { [key: string]: any } = {"100": "_100", "200": "_200", "300": "_300", "400": "_400", "500": "_500", "600": "_600", "700": "_700", "800": "_800", "900": "_900", "bold": "bold", "normal": "normal"};
...
// tslint:disable-next-line:interface-over-type-literal
export type ellipsizeMode = "tail" | "head" | "clip" | "middle";

// tslint:disable-next-line:interface-over-type-literal
export type size = "h4" | "h5" | "h3" | "h1" | "h2";
...
export const make: React.ComponentType<{
  ...
  const $props = {children:Arg1.children, color:Arg1.color, ellipsizeMode:Arg1.ellipsizeMode, numberOfLines:Arg1.numberOfLines, onPress:Arg1.onPress, size:Arg1.size, style:Arg1.style, testID:Arg1.testID, theme:Arg1.theme, weight:(Arg1.weight == null ? undefined : $$toRE574697216[Arg1.weight])};
  const result = React.createElement(TextBS.make, $props);
  return result
};
