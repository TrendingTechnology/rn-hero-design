/* TypeScript file generated from Container.re by genType. */
/* eslint-disable import/first */


import * as React from 'react';

const $$toRE228976081: { [key: string]: any } = {"column": "column", "row": "row", "column-reverse": "columnReverse", "row-reverse": "rowReverse"};

// tslint:disable-next-line:no-var-requires
const ContainerBS = require('./Container.bs');
...
}> = function Container(Arg1: any) {
  const $props = {children:Arg1.children, direction:(Arg1.direction == null ? undefined : $$toRE228976081[Arg1.direction]), fluid:Arg1.fluid, style:Arg1.style, theme:Arg1.theme};
  const result = React.createElement(ContainerBS.make, $props);
  return result
};
...
export const $$default: React.ComponentType<{
  ...
  const $props = {children:Arg1.children, direction:(Arg1.direction == null ? undefined : $$toRE228976081[Arg1.direction]), fluid:Arg1.fluid, style:Arg1.style, theme:Arg1.theme};
  const result = React.createElement(ContainerBS.default, $props);
  return result
};
