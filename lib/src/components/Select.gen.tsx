/* TypeScript file generated from Select.re by genType. */
...
const SelectBS = require('./Select.bs');

import {Style_t as ReactNative_Style_t} from '../../src/shims/ReactNative.shim';

export interface Ioption_ { readonly label: string; readonly value: string };
export type Option = Ioption_;

// tslint:disable-next-line:interface-over-type-literal
export type Props = {
  readonly onChange?: (_1:string) => void; 
  readonly onDismiss?: () => void; 
  readonly options?: Ioption_[]; 
