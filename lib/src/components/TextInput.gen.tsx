/* TypeScript file generated from TextInput.re by genType. */
...
import {TextInput_changeEvent as ReactNative_TextInput_changeEvent} from '../../src/shims/ReactNative.shim';

import {TextInput_keyPressEvent as ReactNative_TextInput_keyPressEvent} from '../../src/shims/ReactNative.shim';

import {TextInput_selectionChangeEvent as ReactNative_TextInput_selectionChangeEvent} from '../../src/shims/ReactNative.shim';
...
// tslint:disable-next-line:interface-over-type-literal
export type autoCapitalize = "none" | "words" | "characters" | "sentences";
...
export type Props = {
  ...
  readonly onChange?: (_1:ReactNative_TextInput_changeEvent) => void; 
  readonly onChangeText?: (_1:string) => void; 
  readonly onFocus?: () => void; 
  readonly onKeyPress?: (_1:ReactNative_TextInput_keyPressEvent) => void; 
  readonly onPressIcon?: (_1:ReactNative_Event_pressEvent) => void; 
  readonly onSelectionChange?: (_1:ReactNative_TextInput_selectionChangeEvent) => void; 
...
export const make: React.ComponentType<{
  ...
  readonly value?: string; 
  readonly wrapperStyle?: ReactNative_Style_t
}> = function TextInput(Arg1: any) {
  const $props = {autoCapitalize:Arg1.autoCapitalize, autoCorrect:Arg1.autoCorrect, autoFocus:Arg1.autoFocus, children:Arg1.children, defaultValue:Arg1.defaultValue, disabled:Arg1.disabled, error:Arg1.error, errorStyle:Arg1.errorStyle, iconStyle:Arg1.iconStyle, inputStyle:Arg1.inputStyle, keyboardType:(Arg1.keyboardType == null ? undefined : $$toRE8806304[Arg1.keyboardType]), label:Arg1.label, labelStyle:Arg1.labelStyle, multiline:Arg1.multiline, onBlur:Arg1.onBlur, onChange:Arg1.onChange, onChangeText:Arg1.onChangeText, onFocus:Arg1.onFocus, onKeyPress:Arg1.onKeyPress, onPressIcon:Arg1.onPressIcon, onSelectionChange:Arg1.onSelectionChange, placeholder:Arg1.placeholder, rightIcon:Arg1.rightIcon, secureTextEntry:Arg1.secureTextEntry, testID:Arg1.testID, theme:Arg1.theme, value:Arg1.value, wrapperStyle:Arg1.wrapperStyle};
  const result = React.createElement(TextInputBS.make, $props);
  return result
};
...
export const $$default: React.ComponentType<{
  ...
  const $props = {autoCapitalize:Arg1.autoCapitalize, autoCorrect:Arg1.autoCorrect, autoFocus:Arg1.autoFocus, children:Arg1.children, defaultValue:Arg1.defaultValue, disabled:Arg1.disabled, error:Arg1.error, errorStyle:Arg1.errorStyle, iconStyle:Arg1.iconStyle, inputStyle:Arg1.inputStyle, keyboardType:(Arg1.keyboardType == null ? undefined : $$toRE8806304[Arg1.keyboardType]), label:Arg1.label, labelStyle:Arg1.labelStyle, multiline:Arg1.multiline, onBlur:Arg1.onBlur, onChange:Arg1.onChange, onChangeText:Arg1.onChangeText, onFocus:Arg1.onFocus, onKeyPress:Arg1.onKeyPress, onPressIcon:Arg1.onPressIcon, onSelectionChange:Arg1.onSelectionChange, placeholder:Arg1.placeholder, rightIcon:Arg1.rightIcon, secureTextEntry:Arg1.secureTextEntry, testID:Arg1.testID, theme:Arg1.theme, value:Arg1.value, wrapperStyle:Arg1.wrapperStyle};
  const result = React.createElement(TextInputBS.default, $props);
  return result
};
