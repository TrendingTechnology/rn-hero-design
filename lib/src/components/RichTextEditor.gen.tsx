/* TypeScript file generated from RichTextEditor.res by genType. */
...
const RichTextEditorBS = require('./RichTextEditor.bs');
...
export type Props = {
  ...
  readonly initialValue?: Js_Json_t; 
  readonly name: string; 
  readonly onChange?: (_1:Js_Json_t) => void; 
  readonly onCursorChange?: (_1:Js_Json_t) => void; 
