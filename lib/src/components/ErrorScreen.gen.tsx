/* TypeScript file generated from ErrorScreen.re by genType. */
...
const ErrorScreenBS = require('./ErrorScreen.bs');

import {Event_pressEvent as ReactNative_Event_pressEvent} from '../../src/shims/ReactNative.shim';

import {Image_Source_t as ReactNative_Image_Source_t} from '../../src/shims/ReactNative.shim';
...
export type Props = {
  ...
  readonly imageSource: ReactNative_Image_Source_t; 
  readonly onPressClose?: (_1:ReactNative_Event_pressEvent) => void; 
