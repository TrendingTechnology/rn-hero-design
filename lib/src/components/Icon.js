...
import piggyBankOutline from '../icons/piggy-bank-outline.svg';
import targetOutline from '../icons/target-outline.svg';
import singleRightOutline from '../icons/single-right-outline.svg';
...
const Icon = ({ icon, size = 24, color, wrapperStyle, theme, ...props }) =>
  SVG_ICONS[icon] ? (
    <View
...
export default injectTheme(Icon);
