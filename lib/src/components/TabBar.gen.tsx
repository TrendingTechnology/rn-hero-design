/* TypeScript file generated from TabBar.re by genType. */
...
const TabBarBS = require('./TabBar.bs');
...
export type Props = {
  ...
  readonly onSelect?: (_1:number) => void; 
  readonly selectedIndex?: number; 
  readonly tabStyle?: ReactNative_Style_t; 
  readonly theme?: {
    readonly _switch: {
