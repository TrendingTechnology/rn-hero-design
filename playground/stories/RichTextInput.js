...
const RichTextInputScreen = ({ theme }) => {
  const [value, setValue] = React.useState([
    { text: 'Test ' },
    { text: '@Gia Toan', ref: '3' },
    { text: ' and ' },
    { text: 'bold text', mark: 'bold' },
    { text: ' and ' },
    { text: 'italic text', mark: 'italic' },
    { text: ' and ' },
    { text: 'underline text', mark: 'underline' },
  ]);
...
RichTextInputScreen.navigationOptions = {
  title: 'Announcement',
  headerStyle: {
...
export default injectTheme(RichTextInputScreen);
